...
@section('title', __('Planos sob medida para você'))
        ...
        <div class="flex flex-col gap-14">
            <div class="w-full">
                ...
                >
                    <div class="mb-8 flex flex-wrap items-center justify-between gap-4">
                        <h3 class="mb-0">
                            @lang('Aqui está o resumo do seu plano:')
                        </h3>
            ...
            <div class="w-full">
                ...
                <p class="mb-5 lg:w-1/3">
                    @lang('Utilize todo o poder da Tay AI, selecione um plano de assinatura ou um pacote de tokens para atualizar seu plano atual.')
                </p>
