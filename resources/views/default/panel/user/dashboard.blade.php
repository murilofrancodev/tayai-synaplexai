        ...
        >
            ...
            <x-card size="lg">
                <h3 class="mb-6 flex items-center gap-3">
                    ...
                    @lang('Como posso te ajudar hoje?')
                </h3>
                <x-header-search
                    class="mb-5 w-full"
                ...
                >
                    @lang('Criar um Documento em Branco')
                    <span
            ...
            >
                @if ($team)
                    ...
                    <p class="mb-6 text-center text-xl font-semibold">
                        @lang('Adicione o e-mail dos membros da sua equipe <br> para colaborar.')
                        ðŸ“§
                    </p>
                    <form
                ...
                @else
                    ...
                    <ol class="mb-12 flex flex-col gap-4 text-heading-foreground">
                        <li>
                            ...
                            {!! __('You <strong>Envie o link de <strong>convite</strong> para seus amigos.') !!}
                        </li>
                        <li>
                            <span class="size-7 me-2 inline-flex items-center justify-center rounded-full bg-primary/10 font-extrabold text-primary">
                                2
                            </span>
                            {!! __('<strong>Eles se inscrevem<strong> em um plano pago</strong> usando o seu link de referência.') !!}
                        </li>
                        <li>
                            <span class="size-7 me-2 inline-flex items-center justify-center rounded-full bg-primary/10 font-extrabold text-primary">
                                3
                            </span>
                            {!! __('A partir da primeira compra deles, você começará a <strong>ganhar comissões recorrentes</strong>.</strong>.') !!}
                        </li>
                    </ol>
