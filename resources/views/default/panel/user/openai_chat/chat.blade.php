        ...
        <div class="lqd-chat-ai-bubble group mb-2 flex content-start gap-2">
            ...
            <div
                ...
                <div class="inline-flex max-w-full items-center rounded-full font-medium leading-none">
                    ...
                    @endif
                    <div
                        class="chat-content prose relative w-full max-w-none px-5 py-3.5 indent-0 font-[inherit] text-xs font-normal text-current [word-break:break-word] empty:hidden [&_*]:text-current"></div>
                    <button
