...
class TicketAction
{
    ...
    {
        $this->status = $this->isSenderAdmin() ? 'Esperando por resposta' : 'Respondido';

        $this->activityType = __('Solicitação de suporte aguardando sua resposta');

        $this->notifyTitle = __('Solicitação de suporte respondida.');
