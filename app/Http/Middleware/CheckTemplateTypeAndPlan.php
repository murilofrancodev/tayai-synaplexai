...
class CheckTemplateTypeAndPlan
{
    public function handle(Request $request, Closure $next): Response
    {
        ...
        return to_route('dashboard.user.payment.subscription')->with(['message' => trans('Se você é novo por aqui e quer aproveitar os recursos premium, é só atualizar seu plano!'), 'type' => 'error']);
    }
